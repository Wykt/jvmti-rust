...
impl JVMTI for Environment {
    ...
    fn get_class_loader_loaded_classes(&self, class_loader: JavaObject) -> Result<Vec<crate::native::JavaClass>, NativeError> {
        self.jvmti.get_class_loader_loaded_classes(class_loader)
    }
